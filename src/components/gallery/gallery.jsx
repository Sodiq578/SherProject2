...
const Gallery = () => {
  ...
  const allMockImages = [
    ...
    // QO'SHIMCHA RASMLAR (11 ta qo'shimcha)
    {
      id: 90,
      url: "https://images.unsplash.com/photo-1683009427698-5c9c6f8b47a9?w=800",
      thumb: "https://images.unsplash.com/photo-1683009427698-5c9c6f8b47a9?w=400",
      title: "Barselona kechasi",
      description: "Barselonaning tungi manzarasi",
      category: "city",
      orientation: "landscape",
      photographer: "Night Shooter",
      photographerAvatar: "https://randomuser.me/api/portraits/men/50.jpg",
      location: "Barcelona, Spain",
      date: "2024-03-28",
      views: 18765,
      likes: 3123,
      ...
      width: 5600,
      height: 3700,
      tags: ["barcelona", "night", "city"],
      featured: true
    },
    {
      id: 91,
      url: "https://images.unsplash.com/photo-1519046904884-53103b34b206?w=800",
      thumb: "https://images.unsplash.com/photo-1519046904884-53103b34b206?w=400",
      title: "Plyaj",
      description: "Tropik plyaj",
      category: "travel",
      orientation: "landscape",
      photographer: "Beach Lover",
    ...
    {
      id: 92,
      url: "https://images.unsplash.com/photo-1511882150382-421056c89033?w=800",
      thumb: "https://images.unsplash.com/photo-1511882150382-421056c89033?w=400",
      title: "Tog' ko'li",
      description: "Tog'lar orasidagi ko'l",
      category: "nature",
      orientation: "landscape",
      photographer: "Mountain Hiker",
      photographerAvatar: "https://randomuser.me/api/portraits/men/51.jpg",
    ...
    {
      id: 93,
      url: "https://images.unsplash.com/photo-1519985176271-adb1088fa94c?w=800",
      thumb: "https://images.unsplash.com/photo-1519985176271-adb1088fa94c?w=400",
      title: "Yovvoyi tabiat",
      description: "Yovvoyi tabiat",
      category: "animals",
      orientation: "portrait",
      photographer: "Wildlife Photographer",
      photographerAvatar: "https://randomuser.me/api/portraits/women/53.jpg",
      location: "Africa",
      date: "2024-03-08",
      views: 16543,
      likes: 2876,
    ...
    {
      id: 94,
      url: "https://images.unsplash.com/photo-1517999144091-3d9dca6d1e43?w=800",
      thumb: "https://images.unsplash.com/photo-1517999144091-3d9dca6d1e43?w=400",
      title: "Kuz",
      description: "Kuzgi barglar",
      category: "nature",
      orientation: "portrait",
      photographer: "Season Watcher",
      photographerAvatar: "https://randomuser.me/api/portraits/men/52.jpg",
      location: "Vermont",
      date: "2024-03-22",
      views: 14567,
      likes: 2543,
    ...
    },
    {
      ...
      thumb: "https://images.unsplash.com/photo-1519974719765-e6559eac2575?w=400",
      title: "Sharshara",
      description: "Muzli sharshara",
      category: "nature",
      orientation: "portrait",
      ...
      width: 3500,
      height: 5200,
      tags: ["waterfall", "ice", "winter"],
      featured: true
    },
    {
      id: 96,
      url: "https://images.unsplash.com/photo-1519971911771-9110b0d10b33?w=800",
      thumb: "https://images.unsplash.com/photo-1519971911771-9110b0d10b33?w=400",
      title: "Yulduzlar",
      description: "Yulduzli osmon",
      category: "nature",
      orientation: "landscape",
      photographer: "Astro Lover",
      photographerAvatar: "https://randomuser.me/api/portraits/men/53.jpg",
      location: "Desert",
      date: "2024-02-28",
      views: 23456,
      likes: 3987,
    ...
    },
    {
      ...
      thumb: "https://images.unsplash.com/photo-1519999482648-25049ddd37b1?w=400",
      title: "Qishloq",
      description: "Qishloq manzarasi",
      category: "nature",
      orientation: "landscape",
      photographer: "Countryside",
      photographerAvatar: "https://randomuser.me/api/portraits/women/55.jpg",
      ...
      width: 5600,
      height: 3700,
      tags: ["village", "mountains", "nature"],
      featured: false
    },
    {
      id: 98,
      url: "https://images.unsplash.com/photo-1520085601670-ee14aa5fa3e8?w=800",
      thumb: "https://images.unsplash.com/photo-1520085601670-ee14aa5fa3e8?w=400",
      title: "Arxitektura",
      description: "Zamonaviy arxitektura",
      category: "architecture",
      orientation: "portrait",
      photographer: "Design Lover",
    ...
    },
    {
      ...
      thumb: "https://images.unsplash.com/photo-1520085601670-ee14aa5fa3e8?w=400",
      title: "Metropolis",
      description: "Katta shahar",
      category: "city",
      orientation: "landscape",
      photographer: "City Dweller",
      photographerAvatar: "https://randomuser.me/api/portraits/women/56.jpg",
      location: "New York",
      date: "2024-02-05",
      views: 25678,
      likes: 4321,
    ...
    },
    {
      ...
      thumb: "https://images.unsplash.com/photo-1520085601670-ee14aa5fa3e8?w=400",
      title: "Yapon bog'i",
      description: "Yapon an'anaviy bog'i",
      category: "nature",
      orientation: "landscape",
      photographer: "Zen Master",
      photographerAvatar: "https://randomuser.me/api/portraits/men/55.jpg",
  ...
  useEffect(() => {
    const totalViews = filteredImages.reduce((acc, img) => acc + img.views, 0);
    const totalLikes = filteredImages.reduce((acc, img) => acc + img.likes, 0);
    const totalDownloads = filteredImages.reduce((acc, img) => acc + img.downloads, 0);
  ...
  const categories = [
    ...
    { id: 'art', name: 'San\'at', icon: <FiImage /> }
  ];
